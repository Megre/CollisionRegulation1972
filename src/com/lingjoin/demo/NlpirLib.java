...
public interface NlpirLib extends Library {
	final String WORK_FOLDER = "C:/Users/TF/Documents/GitHub/NLPIR/NLPIR SDK/NLPIR-ICTCLAS/projects/ICTCLAS_Java";
	
	// 定义并初始化接口的静态变量，通过JNA调用NLPIR.dll;
	NlpirLib Instance = (NlpirLib) Native.loadLibrary(WORK_FOLDER + "/win64/NLPIR", NlpirLib.class);
